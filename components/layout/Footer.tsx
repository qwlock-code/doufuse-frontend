      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Do-U-Fuse</span>
            </div>
            <p className="text-gray-400 max-w-sm mb-4">
              Create amazing fuse bead designs with our free online pattern designer. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/editor" className="hover:text-red-400 transition-colors">Create Pattern</Link></li>
              <li><Link href="/leaderboard" className="hover:text-red-400 transition-colors">Leaderboard</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} Do-U-Fuse. Create Amazing Fuse Bead Designs.
          </p>
